// operatorData.js - generated file
// Shared defaults at top, entries reference them by name
 ...
 * Operator images
 */
export const getOperatorIcon = name => `/assets/operators/icons/${slugify(name)}.png`;
export const getOperatorPicture = name => `/assets/operators/pictures/${slugify(name)}.png`;

/**
 * Weapon images
 */
export const getWeaponImage = (name, type) =>
  `/assets/weapons/${type}/${slugify(name)}.png`;

/**
 * Attachment images
 */
export const getAttachmentImage = (category, name) =>
  `/assets/attachments/${category}/${slugify(name)}.png`;

/**
 * Gadget images
 */
export const getGadgetImage = name =>
  `/assets/gadgets/${slugify(name)}.png`;
...
export const secondaryDefaults = {
  sights: {
    nonmagnifying: [
      "Red Dot A", "Red Dot B", "Red Dot C", "Holo A", "Holo B", "Holo C", "Holo D", "Reflex A", "Reflex B", "Reflex C"
    ],
...
const operatorData = [
  {
    name: "Ace",   role: "attacker", playstyles: attackPlaystyles,
    primaryWeapons: ["AK-12","M1014"],
    secondaryWeapons:["P9"],
    gadgets: ["Claymore","Breach Charge"] },
  { name: "Amaru", role: "attacker", playstyles: attackPlaystyles,
  ...
  },
  {
    ...
    playstyles: attackPlaystyles.playstyles.playstyle
  },
  {
    name: "Smoke",
    role: "defender",
  ...
  },
  {
    ...
    playstyles: defendPlaystyles.playstyles.playstyle
  },
  {
    name: "Mute",
    role: "defender",
